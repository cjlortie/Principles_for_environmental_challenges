...
{[}{\textbf{???}}{]}, and mobilizing knowledge for solutions requires
both detailed expertise, scientific synthesis tools {[}6{]}, or a focus
on identifying the salient elements associated with a study {[}7,8{]}.
...
conservationists {[}9{]} and inform solutions for the environmental
crisis.
...
reproducibility {[}10{]}. These can include primarily conceptual
...
(repeated tests of the same concept but with different methods) {[}11{]}
...
{[}12{]}. We propose that by distilling the concepts that promote
...
resulting in increased likelihoods for human-wildlife conflict {[}13{]}.
...
is a common issue in ecology {[}14{]}, and proposing a spatial scale,
...
{[}13{]}. Consequently, a clear statement of evidence can illuminate the
...
difficult to raise {[}15,16{]}. Many large carnivores are already
...
potential extinction of keystone species {[}17--19{]}; but it is often
associated with underlying human-human conflict {[}20{]}.
...
of the ecosystem is impossible to quantify {[}21{]}, but linking the
...
is no perfect experiment {[}{\textbf{???}}{]} or synthesis {[}24{]}.
...
environmental management challenges {[}{\textbf{???}},25{]}. At the
...
{[}26,27{]}, and whilst this is not without debate, this can expand the
...
environmental data {[}28{]} is relevant to many of the challenges we
...
bio-monitoring of environmental quality'' {[}29{]} clearly provides a
...
this role include economic incentivization models ({[}30{]}), human
health impact studies {[}31{]}, and human well-being monitoring
associated with environmental interventions {[}32{]}.
...
general {[}33{]}. Evidence-based decision making is a critical area for
growth and knowledge in many disciplines {[}34--36{]} - not just
...
\midrule
\endhead
meta-analysis & {[}37,38{]}\tabularnewline
systematic review & {[}5{]}\tabularnewline
citizen science & {[}{\textbf{???}},39{]}\tabularnewline
team science & {[}40{]}\tabularnewline
R & {[}{[}41{]}{]}\tabularnewline
mapping & {[}42{]}\tabularnewline
big data/open access databases & {[}43--45{]}\tabularnewline
modelling & {[}46{]}\tabularnewline
surveys & {[}47{]}\tabularnewline
biomonitoring & {[}29{]}\tabularnewline
evolutionary change/population viability genetic analysis &
{[}{\textbf{???}}{]}\tabularnewline
economic incentive monitoring & {[}48{]}\tabularnewline
human health and well-being monitoring & {[}13,49{]}\tabularnewline
\bottomrule
\end{longtable}

meta-analysis {[}37{]}; {[}38{]} systematic review {[}5{]} citizen
science {[}39{]}; {[}50{]} team science {[}40{]} R {[}41{]} mapping
{[}42{]} big data/open access databases {[}43{]}; {[}44{]}; {[}45{]}
modelling {[}46{]} surveys {[}47{]} biomonitoring {[}29{]} evolutionary
change/population viability genetic analysis {[}51{]} economic
...
10. Baker M. Is there a reproducibility crisis? Nature. 2016;533:
452--454.

\hypertarget{ref-Kelly2006}{}
11. Kelly C. Replicating empirical research in behavioral ecology: How
and why it should be done but rarely ever is. The Quarterly Review of
Biology. 2006;81: 221--236.

\hypertarget{ref-Bourne2006}{}
12. Bourne PE, Chalupa LM. Ten simple rules for getting grants. PLoS
...
13. Dickman AJ, Hazzah L, Carbone C, Durant SM. Carnivores, culture and
...
14. Sandel B. Towards a taxonomy of spatial scale-dependence. Ecography.
2015;38: 358--369.
doi:\href{https://doi.org/10.1111/ecog.01034}{10.1111/ecog.01034}

\hypertarget{ref-Jones2009}{}
15. Jones PG, Thornton PK. Croppers to livestock keepers: livelihood
...
16. Lindsey PA, Romañach SS, Davies-Mostert HT. The importance of
...
17. Towns L, Derocher AE, Stirling I, Lunn NJ, Hedman D. Spatial and
...
18. Bagchi S, Mishra C. Living with large carnivores: Predation on
...
19. Johnson A, Vongkhamheng C, Hedemark M, Saithongdam T. Effects of
...
20. Dickman AJ. Complexities of conflict: The importance of considering
...
21. Davidson MD. On the relation between ecosystem services, intrinsic
...
22. Reed MS. Stakeholder participation for environmental management: A
...
23. Colvin RM, Witt GB, Lacey J. Approaches to identifying stakeholders
...
24. Kotiaho J, Tomkins J. Meta-analysis, can it ever fail? Oikos.
2002;96: 551--553.

\hypertarget{ref-Mosnier2017}{}
25. Mosnier C, Duclos A, Agabriel J, Gac A. What prospective scenarios
...
26. Fu Q, Hou Y, Wang B, Bi X, Li B, Zhang X. Scenario analysis of
...
27. Karttunen K, Ahtikoski A, Kujala S, Törmä H, Kinnunen J, Salminen H,
...
28. McKinley DC, Miller-Rushing AJ, Ballard HL, Bonney R, Brown H,
...
29. Miguel TB, Oliveira-Junior JMB, Ligeiro R, Juen L. Odonata (Insecta)
...
30. Tilman AR, Levin S, Watson JR. Revenue-sharing clubs provide
...
31. Chiabai A, Quiroga S, Martinez-Juarez P, Higgins S, Taylor T. The
...
32. McKinnon M. Sustainability: Map the evidence. Nature. 2015;528:
185--187.
doi:\href{https://doi.org/10.1017/CBO9781107415324.004}{10.1017/CBO9781107415324.004}

\hypertarget{ref-Pace2010}{}
33. Pace ML, Hampton SE, Limburg KE, Bennett EM, Cook EM, Davis AE, et
...
34. Roy-Byrne P, Craske MG, Sullivan G, Rose RD, Edlund MJ, Lang AJ, et
...
35. Tranfield D, Denyer D, Smart P. Towards a Methodology for Developing
Evidence-Informed Management Knowledge by Means of Systematic Review.
2003;14: 207--222.

\hypertarget{ref-Aarons2011}{}
36. Aarons GA, Hurlburt M, Horwitz SMC. Advancing a conceptual model of
...
37. Castanho C de T, Lortie CJ, Zaitchik B, Prado PI. A meta-analysis of
...
38. Busch J, Ferretti-Gallon K. What drives deforestation and what stops
...
39. Burkle LA, Marlin JC, Knight TM. Plant-Pollinator Interactions over
120 Years: Loss of Species, Co-Occurrence, and Function. Science.
2013;339: 1611--1616.

\hypertarget{ref-Nielsen2017}{}
40. Nielsen JA, Grøndahl E, Callaway RM, Dickinson KJ, Ehlers BK. Home
...
41. McCarthy MP, Best MJ, Betts RA. Climate change in cities due to
...
42. Halpern B, Walbridge S, Selkoe K, Kappel C, Micheli F, D'Argrosa C,
...
43. Sillero N, Campos J, Bonardi A, Corti C, Creemers R, Crochet PA, et
...
44. Dengler J, Jansen F, Glöckler F, Peet RK, Cáceres M de, Chytrý M, et
...
45. Maldonado C, Molina CI, Zizka A, Persson C, Taylor CM, Albán J, et
...
46. Vogt R, Sharma S, Leavitt P. Direct and interactive effects of
...
47. Wassen MJ, Venterink HO, Lapshina ED, Tanneberger F. Endangered
...
50. Conrad CC, Hilchey KG. A review of citizen science and
...
51. Stoops MA, Campbell MK, DeChant CJ, Hauser J, Kottwitz J, Pairan RD,
