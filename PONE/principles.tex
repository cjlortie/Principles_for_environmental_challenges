...
likelihood for human-wildlife conflict {[}17{]}. Re-framed, the
challenge can be to improve perception of wildlife in areas with high
human-wildlife conflict opportunities. It is a small change in semantics
but a potentially profound change in direction.
...
the most consistent negative drivers of total loss {[}17{]}. Perception
of loss and actual losses were not necessarily equivalent, and culture
was shaping subsequent conflicts not direct evidence. Consequently, a
clear statement of evidence can illuminate the most viable solution sets
in some instances.
...
threatened and endangered, and further anthropogenic pressures on the
...
this is not without debate, this can expand the breadth of stakeholders
...
but there are many tools such as meta-analyses {[}34{]}, big data
{[}35{]}, mapping {[}36{]}, modelling {[}37{]}, citizen science
{[}38{]}, and team science {[}39{]}. The tools in basic biology and
ecology relevant to environmental management can be reproducible if, at
least conceptually, they can be replicated in another system or applied
to similar challenge -- i.e.~citizen science as a means to collect
environmental data {[}40{]} is relevant to many of the challenges we
...
environmental quality'' {[}41{]} clearly provides a means to measure and
detect. However, the other proposed roles can address challenges in a
diversity of ways. The identification of or provision of research
evidence is the most `basic' role, and it is also likely the most
typical role for much of ecology for example. Tools that can function in
this capacity include surveys, citizen science data collection, mapping,
open-access data, and modelling to predict changes. Tests in the second
category that directly examine the efficacy of a management strategy or
intervention can further include bio-monitoring {[}41{]}, mitigation and
remediation experiments {[}42{]}, and population demography studies
{[}43{]}. Studies that inform policy are typically more indirect and
synthetic and can take the form of anthropocentric studies that consider
ecological or environmental policy. Any of the above tools can serve
this role, but some tools that fit most squarely include economic
incentivization models ({[}44{]}), human health impact studies {[}45{]},
and human well-being monitoring associated with environmental
interventions {[}46{]}.
...
general {[}47{]}. Evidence-based decision making is a critical area for
growth and knowledge in many disciplines {[}48--50{]} -- not just
...
facilitate this process, and open science will be pivotal. Using at
...
34. Busch J, Ferretti-Gallon K. What drives deforestation and what stops
...
35. Hampton S, Strasser C, Tewksbury J, Gram W, Budden A, Batcheller A,
et al. Big data and the future of ecology. Frontiers in Ecology \& the
Environment. 2013;11: 156--162.

\hypertarget{ref-Halpern2008}{}
36. Halpern B, Walbridge S, Selkoe K, Kappel C, Micheli F, D'Argrosa C,
...
37. Vogt R, Sharma S, Leavitt P. Direct and interactive effects of
...
38. Burkle LA, Marlin JC, Knight TM. Plant-Pollinator Interactions over
...
40. McKinley DC, Miller-Rushing AJ, Ballard HL, Bonney R, Brown H,
...
41. Miguel TB, Oliveira-Junior JMB, Ligeiro R, Juen L. Odonata (Insecta)
...
42. Zhu L, Lu L, Zhang D. Mitigation and remediation technologies for
organic contaminated soils. Frontiers of Environmental Science \&
Engineering in China. 2010;4: 373--386.
doi:\href{https://doi.org/10.1007/s11783-010-0253-7}{10.1007/s11783-010-0253-7}

\hypertarget{ref-Botero2015}{}
43. Botero CA, Weissing FJ, Wright J, Rubenstein DR. Evolutionary
tipping points in the capacity to adapt to environmental change.
Proceedings of the National Academy of Sciences of the United States of
America. 2015;112: 184--189. Available:
\url{https://www.jstor.org/stable/26460375}

\hypertarget{ref-Tilman2018}{}
44. Tilman AR, Levin S, Watson JR. Revenue-sharing clubs provide
...
45. Chiabai A, Quiroga S, Martinez-Juarez P, Higgins S, Taylor T. The
...
46. McKinnon M. Sustainability: Map the evidence. Nature. 2015;528:
185--187.
doi:\href{https://doi.org/10.1017/CBO9781107415324.004}{10.1017/CBO9781107415324.004}

\hypertarget{ref-Pace2010}{}
47. Pace ML, Hampton SE, Limburg KE, Bennett EM, Cook EM, Davis AE, et
...
48. Roy-Byrne P, Craske MG, Sullivan G, Rose RD, Edlund MJ, Lang AJ, et
...
49. Tranfield D, Denyer D, Smart P. Towards a Methodology for Developing
Evidence-Informed Management Knowledge by Means of Systematic Review.
2003;14: 207--222.

\hypertarget{ref-Aarons2011}{}
50. Aarons GA, Hurlburt M, Horwitz SMC. Advancing a conceptual model of
